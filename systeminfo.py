...
ALLOWED_ORIGINS = os.getenv("ALLOWED_ORIGINS", "http://localhost:5000,http://localhost:5001,http://localhost:5002,http://localhost:8000,http://localhost:8001,http://127.0.0.1:5000,http://127.0.0.1:5001,http://127.0.0.1:5002,http://127.0.0.1:8000,http://127.0.0.1:8001").split(",")
...
@limiter.limit("60 per minute")  # Add rate limiting
def get_system_info():
    try:
...
# Deployments List
@app.route('/kubernetes_deployments', methods=['GET'])
@limiter.limit("60 per minute")
def get_kubernetes_deployments():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to fetch Kubernetes deployments'}), 500

# Services List
@app.route('/kubernetes_services', methods=['GET'])
@limiter.limit("60 per minute")
def get_kubernetes_services():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to fetch Kubernetes services'}), 500
